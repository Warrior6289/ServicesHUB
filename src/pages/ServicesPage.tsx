...
const serviceCategories = [
  ...
  {
    title: 'Roofing',
    description: 'Roof repair, replacement, and maintenance experts',
    rating: 4.7,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Moving',
    description: 'Professional movers for residential and commercial needs',
    rating: 4.3,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 lg:py-32">
          ...
          >
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Browse Our Services
              <span className="block text-accent-200">Find the Right Professional</span>
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/90">
              From home repairs to specialized services, find skilled professionals ready to help with your projects.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50 dark:bg-slate-800">
        <div className="mx-auto max-w-6xl px-4">
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white sm:text-4xl text-center">
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          >
            ...
            <p className="text-lg mb-8 text-white/90 max-w-2xl mx-auto">
              Join thousands of professionals earning on our platform. Start offering your services today!
            </p>
            <Link
              to="/signup"
