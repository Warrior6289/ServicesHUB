        ...
        <nav className="hidden md:flex gap-4 items-center">
          ...
          {isAuthenticated ? (
            <>
              ...
              <button onClick={logout} className="transition-colors duration-200 hover:text-primary-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 rounded">Logout</button>
            </>
          ) : (
            <>
          ...
          <nav className="mx-auto max-w-6xl px-4 py-3 flex flex-col gap-2">
            ...
            {isAuthenticated ? (
              <>
                ...
                <button onClick={() => { logout(); setOpen(false); }} className="rounded px-2 py-1 transition-colors duration-200 hover:bg-slate-50 dark:hover:bg-slate-800 text-left">Logout</button>
              </>
            ) : (
              <>
